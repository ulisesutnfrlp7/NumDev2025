...
const NewtonMethodCalculator = () => {
  ...
  const formatNumber = (num) =>
    typeof num === 'number' ? num.toFixed(6) : num;
  ...
  return (
    <div className="max-w-6xl mx-auto p-1 min-h-screen">
      <div className="bg-white rounded-2xl shadow-xl p-8">
        ...
        {/* Información */}
        <div className="bg-blue-100 border-l-4 border-blue-500 p-4 mb-6 rounded-lg shadow-sm">
          ...
          <div className="space-y-6">
                ...
                {['a', 'b', 'c'].map((key, i) => (
                  <div key={i}>
                    ...
                    <input
                      ...
                      onChange={(e) =>
                        handleCoefficientChange(key, e.target.value)
                      }
            ...
            <div className="flex gap-3">
              ...
              <button
                ...
                className="flex items-center gap-2 bg-gray-500 text-white px-6 py-2 rounded-xl 
                           hover:bg-gray-600 hover:scale-105 transition-transform shadow-md"
              >
          ...
          <div className="space-y-6">
            ...
            {iterations.length > 0 ? (
              <div className="space-y-4">
                <div className="bg-green-100 border-l-4 border-green-500 p-4 rounded-lg shadow-sm">
                  ...
                  <p className="text-green-700">
                    Raíz aproximada:{' '}
                    <strong>
                      {formatNumber(iterations[iterations.length - 1].x)}
                    </strong>
                  </p>
                ...
                <div className="overflow-x-auto">
                  <table className="w-full bg-white border border-blue-200 rounded-lg shadow-sm">
                    <thead className="bg-blue-50">
                      <tr>
                        {['n', 'xₙ', 'f(xₙ)', "f'(xₙ)", 'Error'].map((h, i) => (
                          <th
                            key={i}
                    ...
                    <tbody className="divide-y divide-blue-100">
                      {iterations.map((iter, i) => (
                        ...
                        >
                          ...
                          <td className="px-3 py-2 text-sm font-mono text-gray-900">
                            {formatNumber(iter.fx)}
                          </td>
                          <td className="px-3 py-2 text-sm font-mono text-gray-900">
                            {formatNumber(iter.fpx)}
                          </td>
                          <td className="px-3 py-2 text-sm font-mono text-gray-900">
              ...
              <div className="text-center py-8 text-gray-500">
                ...
                <p>
                  Ingresa los valores y presiona "Calcular" para ver los
                  resultados
                </p>
              </div>
            )}
        ...
        <div className="mt-8 bg-yellow-100 border-l-4 border-yellow-500 p-4 rounded-lg shadow-sm">
          <h3 className="text-yellow-800 font-semibold mb-2">
            Ejemplo del problema mostrado
          </h3>
